<#=============================================================================
EmbyToSonaar V0.6.0 - Beta - 02/10/2018 #>
...
######
-------------------------------------------------------------------------------#>
$Log_Path = "C:\EmbyToSonarr\Logs\EmbyToSonarr" # $PSScriptRoot is the same place as the EmbyToSonarr.ps1 script file is located. (no trailing "\")

$EmbyServerUrl = "http://192.168.1.150:8988" # can be localhost or IP address e.g. "http://192.168.1.100:8096" include the quotes.
$Emby_User_Name = "Master" # include the quotes.
$Emby_User_Pwd = "password" # If you do not have a pwd then leave as ""

$SonarrHost = "http://192.168.1.150:8989" # localhost or 127.0.0.1 or if you have bound an IP to Sonarr you can use that e.g "http://192.168.1.101:8989"  include the quotes.
$Sonarr_Api_Key = "api_key" #In .../Settings/General
